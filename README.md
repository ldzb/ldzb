...
### Capstone Design
*ADHD 아동의 집중력 향상을 위한 게이미피케이션 모바일 솔루션*
- **Role:** Backend API Development & System Architecture
- **Period:** 2026.03 - 2026.06 (Expected)
- **Repo:** [Organization Repository 바로가기](https://github.com/IS4Ps/Routine-Mate.git)

<br>

## 📜 Certifications
- **SQLD (SQL Developer)** - 국가공인 자격 취득
- **정보처리기사** - 실기 시험 준비 중
